...
const LIBRARY_TEMPLATE = [
  'entity,name,slug,dimension,client,constructs,factor,description,definition,display_order,is_active,is_match_eligible,indicators_low,indicators_mid,indicators_high,anchor_low,anchor_high,strength_commentary,development_suggestion,source,stem,purpose,construct,response_format,reverse_scored,difficulty,weight,status,keyed_answer',
  'dimension,"Drive & Delivery",drive-delivery,,,,,"Execution under pressure","Sustains focus and delivery in demanding contexts",0,true,,"Misses deadlines","Delivers consistently","Drives performance under pressure","Avoids tough delivery moments","Sets the pace and finishes strong","A clear strength — keep stretching the team behind delivery","Pick one critical commitment and protect time on it",executive-performance-partners,,,,,,,,,',
  'factor,"Strategic Influence",strategic-influence,drive-delivery,,"stakeholder-framing:1;strategic-signalling:0.8",,"Shapes direction across stakeholders","Influences decisions and aligns effort",,true,true,"Reactive and narrow","Balances priorities","Creates alignment and momentum","Reacts rather than shapes","Frames the strategic narrative and earns buy-in","Use this to broker decisions across silos","Practice naming the strategic stake before pitching tactics",executive-performance-partners,,,,,,,,,',
  'construct,"Stakeholder Framing",stakeholder-framing,,,,strategic-influence,"Frames ideas for different audiences","Tailors messages to influence different stakeholders",,true,,"One-size-fits-all communication","Adapts to some audiences","Tailors messages precisely","Sends one message to everyone","Reads the room and tailors the pitch",,,executive-performance-partners,,,,,,,,,',
  'construct,"Ethical Compass",ethical-compass,drive-delivery,,,,"Anchors decisions in shared values","Applies a clear ethical lens to choices",,true,,"Bends rules under pressure","Holds the line in routine cases","Defends values in hard cases","Yields under commercial pressure","Defends the line publicly when it matters",,,executive-performance-partners,,,,,,,,,',
  'item,,,,,,,,,,,,,,,,,,,executive-performance-partners,"I adapt my message to suit different audiences.",construct,stakeholder-framing,"Likert 5",false,medium,1,active,',
].join('\n')
