...
export function SectionDividerBlock({ data }: { data: Record<string, unknown>; mode?: PresentationMode; chartType?: ChartType }) {
  ...
  switch (style) {
    case 'thick_rule':
      return (
        <div className="mx-10 my-2 print:mx-14 print:my-3">
          <div
    ...
    case 'dot_break':
      return (
        <div className="mx-10 my-2 print:mx-14 print:my-3 text-center tracking-[0.5em]" style={{ color: 'var(--report-muted-colour)' }}>
          &bull;&bull;&bull;
        </div>
      )
    case 'thin_rule':
