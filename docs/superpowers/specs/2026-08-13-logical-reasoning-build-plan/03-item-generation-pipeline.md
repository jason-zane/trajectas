...
| **G-11** | Repeat-heuristic resistance | The key shares a complete layer with ≥ 1 context cell (measured and reported per item; no separate batch-level aggregate threshold — G-17's reconciliation, below, decoupled it from this measure) | §3.5 note | `qa/degeneracy.ts` |
