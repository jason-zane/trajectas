...
export function ClientUsersTable({ clientId, members }: ClientUsersTableProps) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description={`This will revoke ${formatMemberName(removeTarget!) ?? removeTarget?.email ?? "this user"}'s access to this client workspace. They can be re-invited later.`}
        confirmLabel="Remove"
        variant="destructive"
