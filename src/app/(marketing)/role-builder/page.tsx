...
export const metadata: Metadata = {
  title: "Role Builder — Try a role-based assessment | Trajectas",
  description: "Turn a position description into a focused capability assessment. Review the recommendations, try the questions and explore your report.",
  alternates: { canonical: "/role-builder" },
};
...
export default function RoleBuilderLandingPage() {
  ...
  return <div className="px-surface px-home" data-surface="public-experience">
    ...
    <main id="main-content">
      <section className="px-container px-hero">
        <p className="px-kicker">Experience Trajectas · Role Builder</p>
