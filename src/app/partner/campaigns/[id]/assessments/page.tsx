...
export default async function PartnerCampaignAssessmentsPage({
  params,
}: {
  ...
  // The picker offers what the CLIENT has been assigned, with its quota — the
  // partner's own allocation is one level up and is spent through these.
  ...
  if (campaign.clientId) {
    const clientAssessments = await getClientAssessmentLibrary(campaign.clientId);
