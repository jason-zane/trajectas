...
import type { IntegrationEventType } from '@/lib/integrations/event-types'

export { INTEGRATION_EVENT_TYPES } from '@/lib/integrations/event-types'
export type { IntegrationEventType } from '@/lib/integrations/event-types'
