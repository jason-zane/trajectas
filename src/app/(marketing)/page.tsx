          ...
          <div className="wl-shell">
            ...
            <div className="wl-hero-grid">
              <div className="wl-hero-copy">
                ...
                >
                  <Link href="/build" className="wl-btn wl-btn-primary">
                    Build a role assessment
                  </Link>
                  <a href={`mailto:${CONTACT_EMAIL}`} className="wl-btn wl-btn-ghost">
                    Talk to us
                  </a>
                </div>
                <p className="wl-hero-meta">
                  Paste a position description, get a role-specific assessment. Free, one taker.
                </p>
              </div>
