      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-8 sm:px-6">
        <div className="w-full max-w-[540px] space-y-6">
          <div className="space-y-3 text-center">
            ...
            <p
              className="mx-auto max-w-md text-sm leading-relaxed whitespace-pre-line"
              style={{
                color:
          ...
          <div className="flex justify-center">
            <button
              type="button"
              onClick={onStart}
              className="inline-flex items-center gap-1.5 rounded-lg px-6 py-3 text-sm font-medium transition-colors"
              style={{
