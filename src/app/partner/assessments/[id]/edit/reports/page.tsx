...
import { AssessmentReportsPanel } from "@/app/(dashboard)/assessments/[id]/edit/reports/assessment-reports-panel"

export default async function PartnerAssessmentReportsPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <AssessmentReportsPanel
        ...
        reportTemplatesBasePath="/partner/report-templates"
      />
    </div>
  )
}
