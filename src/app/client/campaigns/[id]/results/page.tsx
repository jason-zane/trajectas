...
export default async function ClientCampaignResultsPage({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Note: Report snapshots are managed by the consulting partner */}
      <Card>
        <CardContent className="py-8 text-center text-sm text-muted-foreground">
          Report generation and release is managed by your consulting partner.
          Released reports will appear in your Reports section.
        </CardContent>
      </Card>
    </div>
  );
