...
export const BLOCK_REGISTRY: Record<BlockType, BlockMeta> = {
  cover_page: {
    ...
    defaultConfig: { showDate: true, subtitle: null, showLogo: true, showPoweredBy: true, poweredByText: 'Powered by Trajectas', showAssessmentName: true, showCampaignName: false, showReportName: false },
  ...
  closing_page: {
    label: 'Closing Page',
    category: 'meta',
    description: 'Methodology, score band meanings, and confidentiality note.',
    defaultConfig: { methodologyText: '', showBandLegend: true, confidentialityText: '' },
    supportedModes: ['open'],
    defaultMode: 'open',
  },
  score_overview: {
    ...
    category: 'score',
    description: 'Every factor as a spine row (name, band, score, bar) — or radar, gauges, scorecard.',
    defaultConfig: { displayLevel: 'factor', groupByDimension: true, showDimensionScore: true, showScore: true, showBandLabel: true, depth: 'glance' },
    supportedModes: ['featured', 'open', 'split'],
    supportedCharts: ['bar', 'radar', 'gauges', 'scorecard'],
    defaultMode: 'open',
  },
  dimension_chapter: {
    label: 'Dimension Chapters',
    category: 'score',
    description: 'One chapter per dimension: hero score plus its factors at your chosen depth.',
    defaultConfig: { depth: 'standard', dimensionIds: [], showDimensionSummary: true, chapterFlow: 'auto' },
    supportedModes: ['open'],
    defaultMode: 'open',
  },
  score_detail: {
